...
Raster Order Groups are supported right now only on desktop Intel IGPUs (well and A11..) right now.. at WWDC Metal2 sessions was shared Vega GPUs should expose support for it.. although not yet in 10.13.2 betas..
